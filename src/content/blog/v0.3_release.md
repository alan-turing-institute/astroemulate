...
title: "v0.3 release"
pubDate: "2025-04-29"
description: "Blog to accompany v0.3 release"
draft: true
...
![image_720](https://hackmd.io/_uploads/ry8dq7T1gx.png)


- This [tutorial](https://alan-turing-institute.github.io/autoemulate/tutorials/01_start.html#history-matching) demonstrates how users can employ their own simulator in AutoEmulate's framework. Furthermore it elaborates on the  use of calibration and analysis tools as well adding a visualisation dashboard as a part of AutoEmulate package.
